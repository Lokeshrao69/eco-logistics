...
class EcoLogisticsEnv:
    ...
    def _grade_restock(self) -> GraderResult:
        ...
        if not self._history:
            return GraderResult(task_id="restock_only", score=0.0, feedback="No steps taken.")
    ...
    def _grade_balanced(self) -> GraderResult:
        ...
        """
        if not self._history:
            return GraderResult(task_id="inventory_balanced", score=0.0, feedback="No steps taken.")
    ...
    def _grade_net_zero(self) -> GraderResult:
        ...
        if not self._history:
            return GraderResult(task_id="net_zero_profit", score=0.0, feedback="No steps taken.")
